...
def add_form():
    ...
    nouvelle_formation= formation(Etablissement=ecole, Nom=nom, Image=fichier, Niveau=niveau, description=Description, date_debut=Date_Debut, date_fin=Date_Fin)
...
def Add_exp():
    ...
    nouvelle_experience= experience(Entreprise=entreprise, Image=fichier, Poste=Poste, description=description, date_debut=debut, date_fin=fin)
...
def Add_pro():
    ...
    nouveau_projet= projet(Titre=Titre, Descriptiion=description, Image=fichier, lien=lien, date_debut=debut, date_fin=fin)
